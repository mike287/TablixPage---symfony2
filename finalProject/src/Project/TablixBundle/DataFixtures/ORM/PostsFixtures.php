...
use Project\TablixBundle\Entity\Post;
...
class PostsFixtures extends AbstractFixture implements OrderedFixtureInterface{
    ...
    public function load(ObjectManager $manager) {
            ...
            array(
                ...
                'category' => 'Lorem',
                'tags' => array('#follow', '#tweegram', '#happy'),
                'author' => 'kowal',
                'createDate' => '2012-01-01 12:12:12',
            ...
            array(
                ...
                'category' => 'piłka',
                'tags' => array('#happy', '#summer', '#follow', '#tweegram'),
                'author' => 'John',
                'createDate' => '2012-01-01 12:12:12',
            ...
            array(
                'title' => 'AC Milan',
                'content' => '<p>Duis luctus diam tempor posuere, nibh faucibus gravida non, tellus. Aenean augue euismod id, odio. Aliquam eleifend, ligula. Pellentesque placerat. Vivamus ullamcorper varius in, mollis tincidunt, velit in wisi. Nulla vestibulum ac, mat</p>',
                'category' => 'piłka',
                'tags' => array('#iphoneonly','#summer'),
                'author' => 'mike',
                'createDate' => '2012-01-01 12:12:12',
                'publishedDate' => '2013-05-11 13:10:11',
            ),
            ...
            array(
                'title' => 'Koszykówka a-z',
                'content' => '<p>Pellentesque at urna orci quis mauris. Pellentesque fermentum facilisis. Fusce fringilla vel, eleifend et, tempus dignissim. Phasellus purus. Duis luctus diam tempor posuere, nibh faucibus gravida non, tellus.</p>',
                'category' => 'kosz',
                'tags' => array('#summer','#tweegram'),
                'author' => 'John',
                'createDate' => '2012-01-01 12:12:12',
                'publishedDate' => '2013-05-11 13:10:11',
            ),
            ...
            array(
                'title' => 'Testy testowe2',
                'content' => '<p>Donec nec tortor. Morbi hendrerit. Donec non enim ac ligula in dui eu mollis nulla a ante ipsum ut nibh. Ut molestie, felis eget elit tincidunt tempus. In purus sem rutrum posuere suscipit faucibus o</p>',
                'category' => 'testowe',
                'tags' => array('#happy'),
                'author' => 'paul',
                'createDate' => '2012-01-01 12:12:12',
            ...
            array(
                'title' => 'Testy testowe3',
                'content' => '<p> Donec nec tortor. Morbi hendrerit. Donec non enim ac ligula in dui eu mollis nulla a ante ipsum ut nibh. Ut molestie, felis eget elit tincidunt tempus. In purus sem rutrum posuere suscipit faucibus orci luctus diam. Aliquam </p>',
                'category' => 'testowe',
                'tags' => array('#happy','#tweegram'),
                'author' => 'paul',
                'createDate' => '2012-01-01 12:12:12',
                'publishedDate' => '2013-05-11 13:10:11',
            ),
